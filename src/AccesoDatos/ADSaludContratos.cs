...
namespace AccesoDatos
{
    ...
    public class ADSaludContratos
    {
        ...
        public List<ENSaludContratos> ObtenerTodos(int page, int rows, string CodigoCliente, string Keywords)
        {
            DbCommand oCommand = null;
            List<ENSaludContratos> oListaSaludContratos = new List<ENSaludContratos>();
            try
            {
                oCommand = GenericDataAccess.CreateCommand(dataProviderName, connectionString, "usp_GenSaludContratos_sel_V2");
        ...
        public ENSaludContratos ObtenerUno(string CodigoCliente, string CodigoContrato)
        {
            ...
            try
            {
                ...
                if (oDataReader.Read())
                {
                    ...
                    oENSaludContratos.CodigoTipoPrima = oDataReader["CodigoTipoPrima"] == DBNull.Value ? "" : oDataReader["CodigoTipoPrima"].ToString();
