...
public bool  Eliminar(DateTime FechaInicioContratoPlan)
{
  ...
  try
  {
           ...
           GenericDataAccess.AgregarParametro(oCommand,"@argFechaInicioContratoPlan",FechaInicioContratoPlan,TipoParametro.DT,Direccion.INPUT);
